...
def create_vector_store(resumeText):
    chunks = chunk_text(resumeText)
    ...
    print(f"Vectorstore created with {vectorDatabase._collection.count()} chunks!")
    return vectorDatabase

resumeText = """'''AKSHAT GAIROLA
